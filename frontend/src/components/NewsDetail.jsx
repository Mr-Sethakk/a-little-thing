...
const PLACEHOLDER_IMG = 'data:image/svg+xml;base64,'
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          ...
          {!news.content && !news.summary && (
            <p className="text-gray-400 text-center py-8">暂无详细内容，可点击"跳转原文"阅读完整文章</p>
          )}
        </div>
      </div>
    </div>
