...
const categoryImages = {
  ...
  '财经': 'data:image/svg+xml;base64,' + btoa(`<svg width="320" height="180" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#fef3c7"/><stop offset="100%" stop-color="#fde68a"/></linearGradient></defs><rect width="320" height="180" fill="url(#g)"/><circle cx="160" cy="75" r="32" fill="none" stroke="#d97706" stroke-width="2.5"/><text x="160" y="85" text-anchor="middle" font-size="28" font-family="serif" font-weight="bold" fill="#d97706">¥</text><line x1="120" y1="110" x2="200" y2="110" stroke="#d97706" stroke-width="2" stroke-linecap="round"/><line x1="130" y1="120" x2="190" y2="120" stroke="#d97706" stroke-width="1.5" stroke-linecap="round" opacity="0.6"/><text x="160" y="165" text-anchor="middle" font-size="13" font-family="sans-serif" fill="#92400e">Finance</text></svg>`),
